...
export default function Blog(){
    ...
    useEffect( () =>{
        ...
        onSnapshot(authorizedUserQuery, function(snapshot) {
            snapshot.docs.map((doc) => { 
                ...
                if (user && authorizedUser.uuid == user.uid){
                    setAuthorized(true);
                }
    ...
    return (
        <div className = "w-full  h-full bg-gray-100">
            <div className = "text-center mt-10">This is a blog about different topics in computer science</div>
            ...
            {/* <div className='columns-1 sm:columns-2 bg-blue-400 max-w-fit lg:columns-3 gap-4 mt-3 space-y-2 m-auto'> */}
                ...
                {posts.map((post) => {
                    return <span className=''>{post}</span>
                })
                }
            </div> 
            {authorized ? 
        ...
        <div className="items-start max-w-xs w-80  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
                ...
                <div className = "flex justify-between ">
                    ...
                    <span className='text-white  text-center h-7 mt-2'>{props.date}fdaf</span>  
                </div>
            </div>
        </div>
    )
