...
import {
  ...
  function ChatRoom(props){
    ...
    useEffect( () =>{
        const recentMessagesQuery = query(collection(getFirestore(), 'messages'), orderBy('timestamp', 'desc'), limit(24));
        onSnapshot(recentMessagesQuery, function(snapshot) {
            ...
            if(dummy && dummy.current && dummy.current.scrollIntoView){
      ...
      //getPerformance();
      return(
          <div className = "h-1/2 w-1/2 ml-auto mr-auto justify-center ">
              This is a chat with no regulations, be nice.
